      ...
      <div className="space-y-8 relative before:absolute before:inset-0 before:ml-5 before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-transparent before:via-slate-700 before:to-transparent">
        {experiences?.map((exp: Experience) => (
          ...
          >
            ...
            <div className="w-[calc(100%-4rem)] md:w-[45%] p-5.5 rounded-xl border border-slate-800 bg-gray-100/10 hover:border-blue-400/30 transition-all duration-200 shadow-xl">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-1 gap-1">
                <div className="font-bold text-slate-100 text-[17px]">
                  {exp.puesto}
                </div>
                {/* Uso de la función formatDate y cambio a Present */}
                <time className="font-medium text-blue-300 text-xs whitespace-nowrap mt-1 sm:mt-0">
