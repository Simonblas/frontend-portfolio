...
const ProjectsSection = () => {
  ...
  } = useApi(portfolioService.getProjects);
  ...
  return (
    <section
      id="projects"
      className="py-20 px-6 max-w-6xl mx-auto border-b-1 border-b-gray-500/50"
    >
      <div className="mb-12 text-center">
        <h2 className="text-3xl font-bold mx-auto mb-2 w-fit italic ">
          Projects
        </h2>
